...
DATA		= plr--8.3.0.18--8.4.sql plr--8.4--8.4.1.sql plr--8.4.1--8.4.2.sql plr--8.4.2--8.4.3.sql \
 			plr--8.4.3--8.4.4.sql plr--8.4.4--8.4.5.sql plr--8.4.5.sql plr--unpackaged--8.4.5.sql
